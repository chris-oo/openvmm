...
- `cargo xflowey vmm-tests-run` - build and run VMM tests with automatic artifact discovery. Use `cargo xflowey vmm-tests-run my_test` to run specific tests, or `--filter "test(name)"` for advanced filtering
