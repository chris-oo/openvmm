...
pub use vmm_test_images::cca_payload::BASE_INITRD_SHA256;
pub use vmm_test_images::cca_payload::INITRD_ARCHIVE_SHA256;
pub use vmm_test_images::cca_payload::KERNEL_ARCHIVE_SHA256;
pub use vmm_test_images::cca_payload::LINUX_IMAGE_SHA256;
pub use vmm_test_images::cca_payload::OPENVMM_DEPS_RELEASE;
